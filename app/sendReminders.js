...
/* This is a function that searches for all alarms in the alarms[] that satisfy the date
Reminder.find({alarms : 'Tue Jan 26 2016 01:00:00 GMT-0600 (Central Standard Time)'},function(err, reminders){
    console.log(reminders);
})
*/